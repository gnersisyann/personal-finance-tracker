      ...
      [
        {
          ...
          'border-text-300 hover:border-primary hover:shadow-cardsHover': !active && !staticDisplay,
        },
        ...customClass,
      ])"
...
const component = computed(() =>
  props.disabled || props.active || props.staticDisplay ? 'article' : props.tag || NuxtLink,
);
